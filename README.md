...
If you found this helpful then you can buy me a coffee at `0x4B56Cfe3349f10d1e5F7aC5De55FAf5C44A6E774`.
...
- Type ``cd PancakeSwap-Prediction-Bot`` (replace with your cloned/downloaded bot folder)
...
⚠️ **WARNING** ⚠️ Please try to bet with the lowest amount so you don't run out of balance before you even start. Please note that on every bet there's 10% fee. If you want to remove this, contact me (`CrJunkie_1992@gmail.com`).
